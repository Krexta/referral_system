        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold">Stone Token</span>
            </div>
            <p className="text-gray-300 leading-relaxed">
              Building the future of decentralized finance on TON Chain with innovative 
              solutions for New Zealand and beyond.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">dVPN</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <p className="text-gray-400 text-sm">
              © 2024 Stone Token. All rights reserved.
            </p>
            <div className="flex items-center space-x-6 mt-4 md:mt-0">
              <span className="text-gray-400 text-sm">Built on TON Chain</span>
              <div className="flex items-center space-x-2">
                <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                <span className="text-gray-400 text-sm">Network Status: Operational</span>
              </div>
            </div>
          </div>
        </div>
